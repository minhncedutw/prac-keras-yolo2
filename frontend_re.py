...
class YOLO(object):
    ...
    def create_callbacks(self, saved_weights_name, log_dir):
    ...
    def evaluate(self, generator,
                 iou_threshold=0.3, score_threshold=0.3, max_detections=100,
                 save_path=None):
...
if __name__ == '__main__':
    argparser = argparse.ArgumentParser(description='YOLO2 frontend!!!')
    argparser.add_argument('-d', '--desc', default='frontend of YOLO2', help='description of the program')
